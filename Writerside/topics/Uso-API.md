...
Para empezar, hay que saber que el Dockerfile que crea el contenedor de la api y junto al comando de creación de docker le pone automáticamente en el puerto 80.

Para acceder a la base de la API, accederemos a lo siguiente  [inicio](http://127.0.0.1), sin embargo, no tiene importante ya que solo mostrará.
...
Por lo que hay que ir a la parte de [documentación](http://localhost/docs#/) 

Esto mostrará los endpoints de la API como los que verá en la siguiente imagen:

![ENDPOINTS](img.png)

Y abajo del todo, se podrá ver los schemas, que son los esquemas de los modelos que se usan para conectarse entre la api y la base de datos.

![schemas](img_1.png)

El código que se verá a continuación es una dependencia para poder conectarse a la base de datos mysql:
...
El primer endpoint que tenemos es un GET para poder buscar dentro de la tabla de artistas marciales con respecto al dni.
...
El siguiente es un GET para comprobar primero si el artista marcial existe en la tabla y en caso de existir, se comprobará la contraseña que se le pasa.
...
Este endpoint es un GET, solo comprueba si existe el artista marcial con respecto al dni.
...
El endpoint que se ve a continuación es un DELETE que permite eliminar un artista marcial con respecto al dni.
...
Este endpoint es un GET que se utiliza para obtener todas las escuelas registradas en la base de datos.
...
Este endpoint es un GET que se utiliza para obtener una escuela específica a partir de su ID.
...
Este endpoint es un POST que se utiliza para crear una nueva escuela en la base de datos.
...
Este endpoint es un DELETE que se utiliza para eliminar una escuela específica a partir de su ID.
...
Este endpoint es un GET que se utiliza para obtener todas las competiciones registradas en la base de datos.
...
Este endpoint es un GET que se utiliza para obtener una competición específica a partir de su ID.
...
Este endpoint es un POST que se utiliza para crear una nueva competición en la base de datos.
...
Este endpoint es un DELETE que se utiliza para eliminar una competición específica a partir de su ID.
...
Este endpoint es un POST que se utiliza para crear un nuevo resultado de una competición.
...
Este endpoint es un DELETE que se utiliza para eliminar un resultado específico a partir de su ID.
...
Este endpoint es un GET que se utiliza para obtener todos los resultados registrados.
...
Este endpoint es un GET que se utiliza para obtener los resultados de un artista específico a partir de su ID.
...
Este endpoint es un GET que se utiliza para obtener los resultados de una competición específica a partir de su ID.
...
Este endpoint es un GET que se utiliza para obtener los resultados de una competición en función de un puesto específico.
...
Insertar un nuevo diccionario de chat (POST)
...
Agregar un mensaje a un chat existente (POST)
...
Obtener un diccionario de chat por ID (GET)
...
Obtener todos los chats de un maestro (GET)
...
Obtener todos los chats de un aprendiz (GET)
...
Eliminar un mensaje de un chat por timestamp (DELETE)
...
Eliminar un chat por ID (DELETE)
...
Esta función se usa para convertir un ObjectId a str
...
Obtener un evento por su ID (GET)
...
Eliminar un evento por su ID (DELETE)
...
Función que permite obtener todos los elementos de la colección
...
Obtener todos los materiales (GET)
...
Obtener un material por su ID (GET)
...
Eliminar un material por su ID (DELETE)
...
Obtener todos los elementos de la cesta (GET)
...
Obtener materiales por artista marcial (GET)
...
Añadir un nuevo item a la cesta (POST)
...
Añadir material a la cesta de un artista marcial (PUT)
...
Eliminar todos los materiales de un artista marcial (DELETE)
...
Eliminar la lista de materiales de un artista marcial (DELETE)
...
Eliminar un material específico de la lista (DELETE)
...
Esta función devuelve todos los elementos de la colección técnicas
...
Obtener todas las técnicas (GET)
...
Obtener una técnica específica (GET)
...
Obtener una kata específica (GET)
